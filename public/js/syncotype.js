...
RG_Syncotype.drawControlBox = function() {
	...
	'<input type="text" name="stype_lheight" id="stype_lheight" value="22" size="2" style="margin-left: 5px !important;" />',
	'</div>',
...
function syncotype_clear() {
	...
	st_box.innerHTML = "<div style='width: 50px; float: left; margin: 2px 0 0 5px;'><img src='http://s.robgoodlatte.com/i/lheight.png' alt='line height' /><br/><input type='text' name='stype_lheight' id='stype_lheight' value='22' size='2' style='margin-left: 5px !important;' /></div>";
